...
def main() -> None:
    ...
    print(f'{"Nem volt beszélő" if phone.waiting_people_num(input_numbers) <= 0 else f"A várakozók száma: {phone.waiting_people_num(input_numbers)} a beszélo a {phone.accepted_caller_num}. hívó."}')
